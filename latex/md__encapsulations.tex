...
\end{DoxyItemize}\hypertarget{md__encapsulations_autotoc_md4}{}\doxysection{Input and power rules}\label{md__encapsulations_autotoc_md4}
\hypertarget{md__encapsulations_autotoc_md5}{}\doxysubsection{Input detection}\label{md__encapsulations_autotoc_md5}
\hypertarget{md__encapsulations_autotoc_md6}{}\doxysubsubsection{Direct measures}\label{md__encapsulations_autotoc_md6}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md__encapsulations_autotoc_md7}{}\doxysubsubsection{Input sense states\+: Input\+Sense}\label{md__encapsulations_autotoc_md7}
...
\end{DoxyItemize}\hypertarget{md__encapsulations_autotoc_md8}{}\doxysubsubsection{Input state -\/ ANALOG, DIGITAL, NA}\label{md__encapsulations_autotoc_md8}
...
\end{DoxyItemize}\hypertarget{md__encapsulations_autotoc_md9}{}\doxysubsubsection{Input/\+Power state machine\+: Power\+State}\label{md__encapsulations_autotoc_md9}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md__encapsulations_autotoc_md10}{}\doxysubsection{Top-\/level state machine}\label{md__encapsulations_autotoc_md10}
\hypertarget{md__encapsulations_autotoc_md11}{}\doxysubsubsection{On Sequence}\label{md__encapsulations_autotoc_md11}
...
\end{DoxyEnumerate}\hypertarget{md__encapsulations_autotoc_md12}{}\doxysubsubsection{State machine}\label{md__encapsulations_autotoc_md12}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md__encapsulations_autotoc_md13}{}\doxysubsection{Summary -\/ Power\+Input\+Control Task()}\label{md__encapsulations_autotoc_md13}

\begin{DoxyEnumerate}
\item Direct read inputs
\end{DoxyEnumerate}
\begin{DoxyEnumerate}
\item Input sense state machines
\begin{DoxyItemize}
\item Determines the input state, including persistence in case of silence on the analog input
\end{DoxyItemize}
\end{DoxyEnumerate}
\begin{DoxyEnumerate}
...
NOTE\+: The output meter shouldn\textquotesingle{}t operate until the amps are on, so wherever the meter update is called should check the power state. 