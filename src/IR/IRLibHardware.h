 ...
 */
  ...
  #else
		#if !defined PCI_ONLY
			#warning "Unable to set IR_RECV_TIMER"
		#endif
	#endif
#endif
...
#else // unknown timer
	#if !defined PCI_ONLY
		#warning "Internal code configuration error, no known IR_SEND_TIMER# defined\n"
	#endif
#endif
...
#else // unknown timer
	#if !defined PCI_ONLY
		#warning "Internal code configuration error, no known IR_RECV_TIMER# defined\n"
	#endif
#endif
